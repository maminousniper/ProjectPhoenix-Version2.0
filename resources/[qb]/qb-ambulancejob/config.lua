...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
        [1] = vector3(-436.97, -324.8, 34.91), -- ZOONAH -- 3rd eye + E
        [2] = vector3(-254.54, 6331.78, 32.43), -- PALETO
        [3] = vector3(-816.81, -1237.37, 6.98), -- VICEROY
    },
    ["duty"] = {
        --[1] = vector3(-432.3, -318.55, 35.46), -- ZOONAH -- 3rd eye
        [1] = vector3(-817.88, -1238.88, 7.34), -- VICEROY
    ...
    ["beds"] = {
        [1] = {coords = vector4(-470.01, -284.07, 35.84, 202.89), taken = false, model = 1631638868},
        [2] = {coords = vector4(-466.71, -282.66, 35.84, 211.1), taken = false, model = 1631638868},
        [3] = {coords = vector4(-462.91, -281.09, 35.84, 195.63), taken = false, model = 1631638868},
        [4] = {coords = vector4(-459.16, -279.47, 35.84, 195.94), taken = false, model = 1631638868},
        [5] = {coords = vector4(-455.26, -277.87, 35.84, 201.64), taken = false, model = 1631638868},
        [6] = {coords = vector4(-448.33, -283.99, 35.83, 14.22), taken = false, model = 1631638868},
        [7] = {coords = vector4(-451.35, -285.32, 35.83, 22.83), taken = false, model = 1631638868},
        [8] = {coords = vector4(-454.73, -286.66, 35.83, 28.55), taken = false, model = 1631638868},
        [9] = {coords = vector4(-460.22, -288.78, 35.83, 18.31), taken = false, model = 1631638868},
        [10] = {coords = vector4(-463.51, -290.23, 35.83, 21.34), taken = false, model = 1631638868},
        [11] = {coords = vector4(-466.91, -291.42, 35.84, 21.25), taken = false, model = 1631638868},
    --- paleto
