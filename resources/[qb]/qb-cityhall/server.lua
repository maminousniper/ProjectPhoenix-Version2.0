...
RegisterServerEvent('rho:newid')
AddEventHandler('rho:newid', function()
    local src = source
...
RegisterServerEvent('rho:newlicense')
AddEventHandler('rho:newlicense', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local ox_inventory = exports.ox_inventory
...
RegisterServerEvent('rho:newweaponlicense')
AddEventHandler('rho:newweaponlicense', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local ox_inventory = exports.ox_inventory
    local cancarry = ox_inventory:CanCarryItem(src, Config.DrivingLicense, 1)-- here incase your license has weight for whatever reason
...
RegisterNetEvent('rho:applytaxijob', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('rho:applytowjob', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('rho:applygarbagejob', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
