...
RegisterNetEvent('jd-postop-startjob', function()
    QBCore.Functions.TriggerCallback('jd-postop-check-group', function(cb)
        if cb then
            ...
            exports.ox_target:removeLocalEntity(ped1, 'Get Task')
...
RegisterNetEvent('jd-postop-loaded', function()
    exports.ox_target:removeGlobalObject('Load Package')
    exports.ox_target:removeZone('postbox')
    ...
    local options = {
        ...
        onSelect = function(data)
            QBCore.Functions.Progressbar("take2_package", "Taking Package.", 5000, false, false, {
                ...
                ClearPedTasksImmediately(PlayerPedId())
                exports.ox_target:removeGlobalVehicle('Take Package')
                handedpack = true
                Wait(200)
                FreezeEntityPosition(PlayerPedId(), false)
    ...
    exports.ox_target:addLocalEntity(customerped, {
        {
            ...
            onSelect = function()
                QBCore.Functions.Progressbar("give2_package", "Giving Package.", 3500, false, false, {
                    ...
                    Wait(200)
                    FreezeEntityPosition(PlayerPedId(), false)
                    exports.ox_target:removeLocalEntity(customerped, 'Give Package') 
                    handedpack = false
                    ClearPedTasks(PlayerPedId())
                    TaskPlayAnim(PlayerPedId(), 'anim@heists@box_carry@', "exit", 3.0, 1.0, -1, 49, 0, 0, 0, 0)
                    DeleteEntity(pack2)
