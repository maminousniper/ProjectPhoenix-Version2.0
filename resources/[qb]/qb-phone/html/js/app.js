    ...
    $.each(data.applications, function(i, app){
        ...
        if ((!app.job || app.job === QB.Phone.Data.PlayerJob.name) && !blockedapp) {
            ...
            if (app.app == "meos") {
                ...
                icon = '<img src="./img/apps/garage.png" class="calc-icon">';  
            } else if (app.app == "advert"){
                icon = '<img src="./img/apps/yellowpages.png" class="calc-icon">';   
            } else if (app.app == "calculator"){
                icon = '<img src="./img/apps/calcilator.png" class="calc-icon">';
            } else if (app.app == "casino"){
                icon = '<img src="./img/apps/betting.png" class="calc-icon">';
            } else if (app.app == "employment"){
                icon = '<img src="./img/apps/jobcenter.png" class="calc-icon">'; 
            } else if (app.app == "debt"){
                icon = '<img src="./img/apps/debt.png" class="calc-icon">';
            } else if (app.app == "wenmo"){
                icon = '<img src="./img/apps/wenmo.png" class="calc-icon">';
            }else if (app.app == "job"){
                icon = '<img src="./img/apps/clockon.png" class="calc-icon">';
            } else if (app.app == "jobcenter"){
                icon = '<img src="./img/apps/groups.png" class="calc-icon">'; 
            } else if (app.app == "crypto"){
                icon = '<img src="./img/apps/stocks.png" class="calc-icon">';   
            } else if (app.app == "taxi"){
                icon = '<img src="./img/apps/taxiapp.png" class="calc-icon">';   
            } else if (app.app == "lsbn"){
                icon = '<img src="./img/apps/news.png" class="calc-icon">';   
            } else if (app.app == "contacts"){
                icon = '<img src="./img/apps/contacts.png" class="calc-icon">';
            } else if (app.app == "details"){
                icon = '<img src="./img/apps/details.png" class="calc-icon">';
            } else if (app.app == "phone"){
                icon = '<img src="./img/apps/phone.png" class="calc-icon">';
            } else if (app.app == "whatsapp"){
                icon = '<img src="./img/apps/messages.png" class="calc-icon">';
            } else if (app.app == "ping"){
                icon = '<img src="./img/apps/ping.png" class="calc-icon">';
            } else if (app.app == "mail"){
                icon = '<img src="./img/apps/mail.png" class="calc-icon">';
            } else if (app.app == "twitter"){
                icon = '<img src="./img/apps/twatter.png" class="calc-icon">';
            } else if (app.app == "documents"){
                icon = '<img src="./img/apps/documents.png" class="calc-icon">';
            } else if (app.app == "houses"){
                icon = '<img src="./img/apps/houses.png" class="calc-icon">';
            } else if (app.app == "crypto"){
                icon = '<img src="./img/apps/stocks.png" class="calc-icon">';
            } else if (app.app == "gallery"){
                icon = '<img src="./img/apps/gallery.png" class="calc-icon">';
            } else if (app.app == "gopro"){
                icon = '<img src="./img/apps/camera.png" class="calc-icon">';
            } else if (app.app == "group-chats"){
                icon = '<img src="./img/apps/discord.png" class="calc-icon">';
            } else if (app.app == "bank"){
                icon = '<img src="./img/apps/invoices.png" class="calc-icon">';                             
            }
    ...
    if (AppObject.length !== 0) {
        if (CanOpenApp) {
            if (QB.Phone.Data.currentApplication == null) {
                ...
                }  else if (PressedApplication == "lester") {
                    $.post('https://qb-phone/GetLesterInfoData', JSON.stringify({}), function(data){
                        console.log("Lester Data: ", data);
                        SetupLesterInfo(data);
                    });
...
QB.Phone.Animations.TopSlideUp2 = function(Object, Timeout, Percentage, cb) {
    $(Object).css({'display':'block'}).animate({
        top: Percentage+"%",
    }, Timeout, function(){
        $(Object).css({'display':'none'});
