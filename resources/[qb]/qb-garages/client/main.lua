...
RegisterNetEvent('qb-garages:client:TakeOutDepot', function(data)
    ...
    if not vehExists then
        ...
        --retreive vehicle if allowed to spawn
        QBCore.Functions.TriggerCallback('qb-garage:server:getVehicleAllowedToSpawn', function(result)
            if result then 
                ...
                print("NOT READY blah days left")
            end
        end, vehicle.plate)
