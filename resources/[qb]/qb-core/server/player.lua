...
function QBCore.Player.CreatePlayer(PlayerData, Offline)
    ...
    function self.Functions.RemoveMoney(moneytype, amount, reason)
        ...
        local getTaxAmount = rhoTaxLevel(category)
        local taxAmount = amount * (getTaxAmount / 100)
...
PaycheckInterval() -- This starts the paycheck systems
