...
function QBCore.Functions.Notify(text, texttype, length)
    ...
    TriggerEvent('bp-notifyprogbar:notify', text or "Something isnt right (contact dev)" , length or 5000, texttype or 'info')
...
function QBCore.Functions.Progressbar(name, label, duration, useWhileDead, canCancel, disableControls, animation, prop, _, onFinish, onCancel)
...
local Events = {
    ['IsPedInAnyVehicle'] = {
        ['false'] = "qb-core/exited-vehicle",
        ['1'] = "qb-core/entered-vehicle",
    },
}
