...
Config.HackItem = "hacking_device" 
...
Config.Store = {
    ...
    [2] = {
        ...
        search = {
            [1] = {
                coords = vec3(-3045.85, 585.31, 7.91),
                size = vec3(1.2, 1.0, 0.95),
                rotation = 17.75, 
            },
            [2] = {
                coords = vec3(-3048.48, 584.33, 7.91),
                size = vec3(2.6, 1.0, 1.8),
                rotation = 17.75,
            },
            [3] = {
                coords = vec3(-3047.12, 587.15, 7.91),
                size = vec3(1.8, 1.0, 0.45),
                rotation = 13.75,
                iscomputer = true
            }
        },
        safe = {
            coords = vector3(-3048.867, 588.4161, 7.908854)
        } 
    },
    [3] = {
