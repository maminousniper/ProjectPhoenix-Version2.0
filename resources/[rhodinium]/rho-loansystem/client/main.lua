...
RegisterNetEvent('loan-system:client:openLoanMenuTar')
AddEventHandler('loan-system:client:openLoanMenuTar', function()
    OpenMenu()
end)
...
function OpenMenu()
    ...
    local managementMenuID = "rho-loan-open-menu"
        ...
        options = {
            {
                ...
                event = 'loan-system:client:requestLoan',
                args = { scores = scores }
            },
            {
                title = "My Loans",
                description = "View your loans",
                event = 'loan-system:client:openMyLoans',
            },
            {
                title = 'Credit Score : ' .. scores,
                description = "Keep this up, Or be refused credit",
            }
        }
    }
...
RegisterNetEvent('loan-system:client:openMyLoans')
AddEventHandler('loan-system:client:openMyLoans', function()
...
RegisterNetEvent('loan-system:client:requestLoan')
AddEventHandler('loan-system:client:requestLoan', function(scores)
    local scores = scores.scores
    local input = lib.inputDialog("Welcome to Pacific Bank!", {
        {
            type = 'select',
            label = 'Type of Loan',
