...
CreateThread(function()
  while true do
    ...
    SetParkedVehicleDensityMultiplierThisFrame(vehDensity)
...
Citizen.CreateThread(function()
    while true do
      ...
      if #toDelete > 0 then
        TriggerServerEvent('rho:peds:rogue', toDelete)
      end
...
RegisterNetEvent('rho:peds:rogue:delete')
AddEventHandler('rho:peds:rogue:delete', function(pNetId)
...
RegisterNetEvent('rho:peds:decor:set')
AddEventHandler('rho:peds:decor:set', function (pNetId, pType, pProperty, pValue)
  local entity = NetworkGetEntityFromNetworkId(pNetId)
