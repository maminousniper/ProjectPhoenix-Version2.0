...
RegisterNetEvent("rho-harness:client:attachHarness", function(ItemData)
    ...
    TriggerServerEvent('rho-harness:server:attachHarness', validateClass(), ItemData)
end)

RegisterNetEvent('rho-harness:client:installHarness', function(plate, action)
    ...
    QBCore.Functions.Progressbar("install_harness", label, Config.InstallTime, false, true, {
        ...
        TriggerServerEvent("rho-harness:server:installHarness", plate, action)
    end, function()
