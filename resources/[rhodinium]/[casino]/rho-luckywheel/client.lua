...
CreateThread(function()
    local LuckyWheelZone = CircleZone:Create(vector3(988.75, 41.63, 71.27), 1.35, {
        name="LuckyWheelZone",
        heading=328.0,
        debugPoly=false,  
        useZ=true,
    ...
    LuckyWheelZone:onPlayerInOut(function(isPointInside)
        if isPointInside then
			text = "The Diamond Casino & Resort - Lucky Wheel $"..Config.startingPrice.." a spin"
			exports['qb-core']:DrawText(text)
			exports['qb-target']:AddCircleZone("LuckyWheel", vector3(988.0, 42.27, 71.52), 0.4, {
				name="LuckyWheel",
				heading=160,
				debugPoly=false,
				useZ=true,
