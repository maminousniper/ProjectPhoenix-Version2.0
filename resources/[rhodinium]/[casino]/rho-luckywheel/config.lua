...
Config.WheelPos = {x = 990.25, y = 42.79, z = 70.55, h =328.0}	-- Where the wheel prop will spawn OR where wheel prop is
Config.startingPrice = 5000
Config.VehiclePrize = '22m5'
Config.VehicleSpawnCoords = vector4(975.85, 40.03, 71.47, 0.0) 
...
Config.Prices = {
	...
	[4]  = {type = 'item', 		name = 'casino_goldchip', 		count = 2500, 	sound = 'chips', 	probability = {a =  10, b =  20}},	--  1.0 %   2.0 -- 25.000 chips
	...
	[9]  = {type = 'item', 		name = 'casino_goldchip', 		count = 200, 	sound = 'chips', 	probability = {a = 120, b = 170}},	--  5.0 %  17.0 -- 20.000 chips
	...
	[12] = {type = 'item', 		name = 'casino_goldchip', 		count = 150, 	sound = 'chips', 	probability = {a = 300, b = 340}},	--  6.0 %  34.0 -- 15.000 chips
	...
	[16] = {type = 'item',		name = 'casino_goldchip', 		count = 100, 	sound = 'chips', 	probability = {a = 610, b = 640}},	--  8.0 %  64.0 -- 10.000 chips
