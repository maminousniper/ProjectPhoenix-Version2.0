...
RegisterNetEvent("doj:client:startingBets", function(args)
    ...
    if waitingForBetState then
        ...
        elseif args == 4 then 
            ...
            local bettingRoul = exports['qb-input']:ShowInput({
                header = "Bet Amount",
                submitText = "Confirm",
                inputs = {
                    {
            ...
            if tonumber(bettingRoul.input) then

                local tmpInput = tonumber(bettingRoul.input)
	...
	while true do
        ...
        if not sittingAtBlackjackTable then
            if closestChair ~= nil and closestChairDist < 1.3 then
                inZone  = true
                text = "The Diamond Casino & Resort - Blackjack - Press E to sit" 
...
CreateThread(function()
    while true do
        ...
        if drawCurrentHand then
            exports['qb-core']:DrawText("Dealers Hand: "..math.floor(dealersHand).." Your hand: "..math.floor(currentHand)) 
        end
        Wait(250) 
    end
end)
