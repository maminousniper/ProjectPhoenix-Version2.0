...
Config.OxInventory = false  -- false for qb-inventory (lj/ps,etc.. same thing). True of Ox_inventory
Config.Target = 'qb-target' -- qtarget, qb-target (ox-target will automatic convert)
...
Config.Plant = {
    ...
    -- GrowthTime = 1,    -- Plant Growing time in 1 minute (only use this for testing)
