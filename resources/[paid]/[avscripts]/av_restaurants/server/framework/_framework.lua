...
function UpdateSociety(job,amount)
    if Config.UsingRenewedBanking then
        ...
        --for job account
        exports['Renewed-Banking']:handleTransaction(job, "Transaction from: " ..Player.PlayerData.citizenid, amount, "Cash Register", "Thank you" , fullname, "deposit")
        --for player
        exports['Renewed-Banking']:handleTransaction(Player.PlayerData.citizenid, "Paid " ..job, amount, "Cash Register", "Thank you for your custom" , fullname, "withdraw")
        return
    end
