        ...
        if job then
            ...
            if societyMoney and tonumber(societyMoney['money']) > 0 then
                if Config.UsingRenewedBanking then
                    ...
                    --job account update
                    exports['Renewed-Banking']:handleTransaction(job, "Withdrawal from: " ..Player.PlayerData.citizenid, tonumber(societyMoney['money']), "Banking withdrawel", "" , "Withdrawal from :" ..fullname, "withdraw")
