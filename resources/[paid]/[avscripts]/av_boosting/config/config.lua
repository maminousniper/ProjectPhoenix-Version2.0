...
Config.RemoveVinMoneyAtBeginning = true -- True if you want to remove the vin money at the beginning of the contract, false it will remove money right before the player scratches the vin
