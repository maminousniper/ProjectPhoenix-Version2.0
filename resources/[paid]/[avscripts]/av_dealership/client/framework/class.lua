...
--  score.speed = speedScore
  ...
  local info = {}
  info['acceleration'] = {name = Lang['acceleration'], value = score.accel}
  info['handling'] = {name = Lang['handling'], value = score.handling}
  info['speed'] = {name = Lang['speed'], value = score.speed}
  info['braking'] = {name = Lang['braking'], value = score.braking}
