...
Config.MoneyAccount = "gne" -- Account used to pay the race fee
...
Config.WinnersPrizes = { -- Divide the prize pot with the 1st, 2nd and 3rd place from a total of 100%
    [1] = {percentage = 70, moneyAccount = "gne", label = "gne"}, --% Percentage for 1st place - account where the winner will receive his prize 
    [2] = {percentage = 20, moneyAccount = "gne", label = "gne"}, --% Percentage for 2nd place - account where the winner will receive his prize 
    [3] = {percentage = 10, moneyAccount = "gne", label = "gne"}, --% Percentage for 3rd place - account where the winner will receive his prize 
