Config = {}
Config.Debug = false -- used for some extra prints in case of possible bugs
...
Config.Crypto = "gne" -- Account type used to buy table/methlab
...
Config.TableCooldown = 60 -- Cooldown (in minutes) for a specific table, default 2 hours
Config.PlayerCooldown = 30 -- Cooldown (in minutes) for a player before he can cook again in a table, default 1 hour.
